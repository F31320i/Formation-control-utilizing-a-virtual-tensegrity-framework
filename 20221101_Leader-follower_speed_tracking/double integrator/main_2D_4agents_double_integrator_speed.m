...
k = sqrt(-speed_leader_cos*speed_leader_3*damping/([1 1 -3 1]*qxd));
D = k*[1;1;-3;1];
omega = D*D';
...
v1=speed_leader_3*[cos(speed_leader_3_alpha);sin(speed_leader_3_alpha)];
v2=speed_leader_3*[cos(speed_leader_3_alpha);sin(speed_leader_3_alpha)];
v3=speed_leader_3*[cos(speed_leader_3_alpha);sin(speed_leader_3_alpha)];
v4=speed_leader_3*[cos(speed_leader_3_alpha);sin(speed_leader_3_alpha)];
