...
%
% 5 agents
% 4 agents undirected graph + 1 follower directed graph
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all; clear all;
clc;
...
syms z1 z2 z3;
wijs =solve(z2 == 0.5, [z1 z2 z3]*[q5d(1) - q1d(1); q5d(1) - q2d(1); q5d(1) - q4d(1)] == speed_leader_3*speed_leader_cos, [z1 z2 z3]*[q5d(2) - q1d(2); q5d(2) - q2d(2); q5d(2) - q4d(2)] == speed_leader_3*speed_leader_sin,z1*z2*z3<0,z1,z2,z3);
omega(5,1) = subs(wijs.z1);omega(5,2) = subs(wijs.z2);omega(5,4) = subs(wijs.z3);
%%
...
for t=1:steps
    ...
    if draw ==1
        ...
        axis equal;
        axis([-2 15 -2 15]);
        x_plot =  [x1(1), x2(1), x3(1), x4(1), x5(1)];
        y_plot =  [x1(2), x2(2), x3(2), x4(2), x5(2)];
...
legend('edge (1,2)','edge (2,3)','edge (3,4)','edge (4,1)','edge (1,3)','edge (2,4)','edge (5,1)','edge (5,2)','edge (5,4)');
...
for i=1:5
    ...
    axis equal;
    xlabel('x');ylabel('y');
    legend([H([1 2 3 4 5]), G, K] ,'agent 1','agent 2','agent 3','agent 4','agent5','initial configuration','final configuration');
